...
# Metodo DELETE: elimina un resultado
def delete_resultado(db: Session, id_resultado: int):
    db_resultado = db.query(Resultado_cuestionario).filter(Resultado_cuestionario.id_resultado_cues==id_resultado).first()

...
def get_prueba_by_id(db: Session, id_microorganismo: int):
    return db.query(Pruebas_bioquimicas).filter(Pruebas_bioquimicas.id_microorganismo == id_microorganismo).first()

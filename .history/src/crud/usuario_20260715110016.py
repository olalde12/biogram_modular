...
from src.schemas.usuarios import UsuarioCreate, Usua
...
def get_usuario_by_email(db: Session, email: EmailStr):
    return db.query(Usuarios).filter(Usuarios.correo == email.lower()).first()

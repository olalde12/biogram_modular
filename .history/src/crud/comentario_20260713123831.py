...
def update_comentario(db: Session, id_comentario: int, comentario: ComentarioCreate):
    db_comentario = db.query(Publicaciones).filter(Publicaciones.id_publicacion == id_publicacion).first()

...
from src.schemas.cuestionario import CuestionarioCreate, CuestionarioUpdate
...
def update_cuestionario(db: Session, id_cuestionario: int, cuestionario: CuestionarioUpdate):

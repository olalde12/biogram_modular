...
createUser.addEventListener("submit", async (event) => {
    ...
    const campo = {nombre: true, apellido: true, correo: true, contrasena: true};
    ...
    if (!campo.nombre || !campo.apellido || !campo.correo || !campo.contrasena) {
        document.getElementById(`error_${}`).innerText = "Campo obligatorio";
        return;
    }

...
from src.api.routes import microorganismos, usuarios, publicaciones, cuestionarios, resultado_cuest, pruebas, resultados, medios
import src.models  
...
app.include_router(publicaciones.router, prefix='/publicaciones', tags=['Etiquetas (cuestionarios)'])

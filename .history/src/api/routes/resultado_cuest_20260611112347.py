...
@router.post('/create', response_model=Resultado_cuestionario)
...
@router.post("/create", response_model=ResultadoCuest)
def create_resultado(resultado: ResultadoCuestCreate, db: Session = Depends(get_db)):
    return resultado_crud.create_rescues(db=db, resultado=resultado)

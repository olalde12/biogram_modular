...
def create_cuestionario(cuestionario: cuestionarios_schema.CuestionarioCreate, db: Session = Depends(get_db)):
    db_cuestionario = cuestionarios_crud.get_cuestionario_by_name(db, nombre=cuestionario.nombre)
    if db_cuestionario:
...
def update_cuestionario(id_microorganismo: int, microorganismo: microorganismo_schema.MicroorganismoCreate, db: Session = Depends(get_db)):

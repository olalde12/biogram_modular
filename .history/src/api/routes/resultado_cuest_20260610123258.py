...
@router.delete('/delete/{id_resultado}', response_model=resultado_schema.ResultadoCuest)
def delete_resultado(id_cuestionario: int, id_usuario: int, db: Session = Depends(get_db)):

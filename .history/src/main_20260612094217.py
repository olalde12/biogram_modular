...
from src.api.routes import microorganismos, usuarios, cuestionarios, resultado_cuest, pruebas, resultados
import src.models  
...
app.include_router(resultados.router, prefix='/resultadps', tags=['Etiquetas (pruebas)'])

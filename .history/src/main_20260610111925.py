...
from src.api.routes import microorganismos, usuarios, cuestionarios, pruebas
import src.models  
...
app.include_router(pruebas.router, prefix='/cuestionarios', tags=['Etiquetas (cuestionarios)'])
